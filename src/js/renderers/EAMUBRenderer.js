...
export class EAMUBRenderer extends AbstractRenderer {
...
constructor(gl, volume, environmentTexture, options) {
    ...
    this._programs = WebGL.buildPrograms(gl, SHADERS.renderers.EAMUB, MIXINS);
}
...
_integrateFrame() {
    ...
    // gl.uniform1f(uniforms.uEmissionCoefficient, (1 - this.albedo) * this.extinction);
    
    // gl.uniform1f(uniforms.uAbsorptionCoefficient, 1);
    // gl.uniform1f(uniforms.uEmissionCoefficient, 1);
    ...
    // gl.uniform1f(uniforms.uMajorant, 2);
    
    gl.uniform1ui(uniforms.uMaxBounces, this.bounces);
    // gl.uniform1ui(uniforms.uMaxBounces, 8);
    
    gl.uniform1ui(uniforms.uSteps, this.steps);
    // gl.uniform1ui(uniforms.uSteps, 1);
